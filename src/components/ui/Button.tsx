...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyle = 'inline-flex items-center justify-center font-display font-semibold rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none cursor-pointer';
  ...
  const sizes = {
    sm: 'px-5 py-2.5 text-sm tracking-wide font-semibold',
    md: 'px-7 py-3.5 text-base tracking-wide font-semibold',
    lg: 'px-9 py-4.5 text-lg tracking-wide font-semibold',
  };
