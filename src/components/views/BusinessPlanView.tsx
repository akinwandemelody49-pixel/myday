...
export const BusinessPlanView: React.FC = () => {
  ...
  return (
    <SectionContainer id="business-plan-view" className="py-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-neutral-100 pb-5 mb-8">
        <div>
          <div className="flex items-center space-x-2 text-[#6C4CF1] mb-1.5">
            <Sparkles className="w-4 h-4 text-[#F4B400]" />
            <span className="text-[10px] font-mono uppercase tracking-wider font-extrabold bg-[#6C4CF1]/10 px-2 py-0.5 rounded-full">Pitch Room</span>
          </div>
          <h2 className="text-xl md:text-2xl font-display font-black tracking-tight text-neutral-800">
            MyDay Business Plan & Pitch Blueprint
          </h2>
          <p className="text-xs text-neutral-400 font-light max-w-2xl mt-0.5">
        ...
        {/* Action Toggles */}
        <div className="flex items-center bg-neutral-100 p-1 rounded-xl mt-4 md:mt-0 self-start">
          <button
      ...
      <AnimatePresence mode="wait">
        {viewMode === 'deck' ? (
          ...
          >
            ...
            <div className="lg:col-span-8 flex flex-col justify-between bg-white border border-neutral-100 rounded-3xl p-6 md:p-8 min-h-[460px] shadow-sm relative overflow-hidden">
              
              {/* Slide decorative background */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-radial from-[#6C4CF1]/5 to-transparent rounded-full blur-xl"></div>
              
              {/* Header inside Slide */}
              <div className="flex items-center justify-between z-10 border-b border-neutral-50 pb-4 mb-4">
                <span className="text-[10px] font-mono font-bold text-[#6C4CF1] tracking-widest uppercase">
                  Slide {currentSlide + 1} of {slides.length}
                </span>
                <span className="text-[9px] font-mono bg-neutral-100 text-neutral-500 px-2 py-0.5 rounded-md font-bold">
                ...
                {slides[currentSlide].id === 'title' ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-4xl font-display font-black tracking-tight text-neutral-800">
                          {slides[currentSlide].title}
                        </h3>
                        <p className="text-md text-[#6C4CF1] font-semibold tracking-wide">
                          {slides[currentSlide].subtitle}
                        </p>
                      </div>
                    </div>
                    <p className="text-sm font-mono text-[#F4B400] tracking-widest font-extrabold uppercase bg-[#F4B400]/5 px-3 py-1 rounded-lg inline-block">
                      {slides[currentSlide].tagline}
                    </p>
                    <div className="space-y-2.5 mt-4">
                      {slides[currentSlide].bullets.map((b, i) => (
                        <div key={i} className="flex items-start space-x-2 text-xs text-neutral-600 leading-relaxed font-light">
                          <CheckCircle2 className="w-4 h-4 text-[#6C4CF1] shrink-0 mt-0.5" />
                          <span>{b}</span>
                        </div>
                      ))}
                    </div>
                    {slides[currentSlide].quote && (
                      <div className="p-4 bg-neutral-50 rounded-2xl border border-neutral-100/50 mt-4">
                        <p className="text-xs text-neutral-500 italic font-light leading-relaxed">
                          "{slides[currentSlide].quote}"
                        </p>
                      </div>
                    )}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3.5">
                      ...
                      <div>
                        <h3 className="text-2xl font-display font-black tracking-tight text-neutral-800 leading-none">
                          {slides[currentSlide].title}
                        </h3>
                    ...
                    <div className="grid grid-cols-1 gap-3.5 mt-6">
                      {slides[currentSlide].bullets.map((bullet, idx) => (
                        <div 
                          key={idx}
                          className="p-4 bg-neutral-50/50 hover:bg-neutral-50 border border-neutral-100/60 rounded-2xl transition-all duration-300 flex items-start space-x-3"
                        >
                          <div className="w-5 h-5 rounded-full bg-[#6C4CF1]/8 flex items-center justify-center shrink-0 text-[10px] font-mono font-bold text-[#6C4CF1] mt-0.5">
                            {idx + 1}
                          </div>
              ...
              {/* Navigation Footer */}
              <div className="flex items-center justify-between border-t border-neutral-50 pt-5 mt-6 z-10">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 flex items-center space-x-1.5 ${
                    currentSlide === 0 
                      ...
                      : 'text-neutral-600 hover:text-neutral-800 hover:bg-neutral-50 cursor-pointer'
                  }`}
                >
                  ...
                  {slides.map((_, idx) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        idx === currentSlide ? 'w-6 bg-[#6C4CF1]' : 'w-1.5 bg-neutral-200 hover:bg-neutral-400'
                      }`}
                    />
                  ))}
                </div>
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 flex items-center space-x-1.5 ${
                    currentSlide === slides.length - 1 
                      ? 'text-neutral-300 bg-neutral-50 cursor-not-allowed' 
                      : 'bg-[#6C4CF1] hover:bg-[#5B3ED6] text-white shadow-xs cursor-pointer'
                  }`}
                >
            ...
            <div className="lg:col-span-4 flex flex-col space-y-6">
              ...
              <div className="bg-white border border-neutral-100 rounded-3xl p-6 shadow-xs space-y-5">
                <div className="flex items-center space-x-2.5 pb-3 border-b border-neutral-50">
                  <div className="w-8 h-8 bg-emerald-50 rounded-lg flex items-center justify-center">
                    <Calculator className="w-4.5 h-4.5 text-emerald-500" />
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-neutral-800">Dynamic Market Estimator</h4>
                    <p className="text-[10px] text-neutral-400 font-light">Interactive projections</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="text-neutral-500 font-medium">Urban Population</span>
                    ...
                    <input
                      ...
                      className="w-full accent-[#6C4CF1] h-1 bg-neutral-100 rounded-lg appearance-none cursor-pointer"
                    />
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="text-neutral-500 font-medium">Market Penetration Target</span>
                      <span className="font-mono font-bold text-[#6C4CF1]">{penetration}%</span>
                    </div>
                    <input
                      type="range"
                      min={0.1}
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="text-neutral-500 font-medium">Average Celebration Budget</span>
                      <span className="font-mono font-bold text-neutral-800">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[11px]">
                      <span className="text-neutral-500 font-medium">Vendor Commission Fee</span>
                      <span className="font-mono font-bold text-neutral-800">{commissionRate}%</span>
                    </div>
                    <input
                      type="range"
                      min={5}
                ...
                <div className="bg-neutral-50 rounded-2xl p-4 border border-neutral-100 space-y-3.5">
                  <div className="flex justify-between items-center text-xs pb-1.5 border-b border-neutral-100/60">
                    <span className="text-neutral-400 font-light">Target Users (Annual):</span>
                    <span className="font-mono font-bold text-neutral-800">
                  ...
                  <div className="flex justify-between items-center text-xs pb-1.5 border-b border-neutral-100/60">
                    <span className="text-neutral-400 font-light">Total Marketplace GTV:</span>
                    <span className="font-mono font-bold text-neutral-800">
                  ...
                  <div className="flex flex-col pt-1">
                    <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-mono font-bold">Projected Annual Revenue</span>
                    <span className="text-xl font-display font-black text-emerald-600 font-mono mt-0.5">
                      ₦{projectRevenue.toLocaleString()}
                    </span>
                    <p className="text-[9px] text-neutral-400 font-light mt-1">
              ...
              <div className="bg-[#6C4CF1]/4 border border-[#6C4CF1]/10 rounded-3xl p-5 space-y-3 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 bg-[#F4B400]/8 rounded-full blur-md"></div>
                <div className="flex items-center space-x-1.5 text-[#6C4CF1]">
                  <LineChart className="w-4 h-4 text-[#F4B400]" />
                  <span className="text-[10px] font-mono uppercase tracking-wider font-extrabold text-neutral-600">The Seed Edge</span>
                </div>
                <h4 className="text-xs font-bold text-neutral-800">Africa's Modern Occasions Infrastructure</h4>
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: -15 }}
            transition={{ duration: 0.3 }}
            className="bg-white border border-neutral-100 rounded-3xl p-6 md:p-10 shadow-sm font-sans space-y-8 max-w-4xl mx-auto"
          >
            
            {/* Elegant Title Block */}
            <div className="text-center space-y-3 pb-8 border-b border-neutral-100">
              <span className="text-xs font-mono font-bold tracking-widest text-[#6C4CF1] uppercase">
                MyDay Celebration Planning Platform
              </span>
              <h1 className="text-3xl md:text-4xl font-display font-black tracking-tight text-neutral-900 leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-5 bg-neutral-50 border border-neutral-100 rounded-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-12 h-12 bg-[#6C4CF1]/4 rounded-full blur-sm" />
                <div className="flex items-center space-x-2 text-[#6C4CF1] mb-2">
            ...
            <div className="space-y-6 pt-2">
              ...
              <div className="space-y-2.5">
                <h3 className="text-md font-bold text-neutral-800 flex items-center space-x-2">
              ...
              <div className="space-y-2.5">
                ...
                <div className="p-4 bg-neutral-50 border border-neutral-100 rounded-xl space-y-2">
                  <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-wider font-extrabold">Unique Value Proposition</span>
              ...
              <div className="space-y-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 pt-3">
                  <div className="p-3 bg-neutral-50 border border-neutral-100 rounded-xl">
                    <span className="text-[9px] font-mono text-[#6C4CF1] font-bold">PHASE 1</span>
                    <h5 className="text-[11px] font-bold text-neutral-800 mt-1">Birthdays Core</h5>
                    <p className="text-[9px] text-neutral-400 font-light mt-1">AI-powered birthday planning, local cakes, surprise timelines.</p>
                  </div>
                  <div className="p-3 bg-neutral-50 border border-neutral-100 rounded-xl">
                    <span className="text-[9px] font-mono text-[#6C4CF1] font-bold">PHASE 2</span>
                    <h5 className="text-[11px] font-bold text-neutral-800 mt-1">Intimate</h5>
                    <p className="text-[9px] text-neutral-400 font-light mt-1">Anniversaries, romantic proposals, baby & bridal showers.</p>
                  </div>
                  <div className="p-3 bg-neutral-50 border border-neutral-100 rounded-xl">
                    <span className="text-[9px] font-mono text-[#6C4CF1] font-bold">PHASE 3</span>
                    <h5 className="text-[11px] font-bold text-neutral-800 mt-1">Grand Occasions</h5>
                    <p className="text-[9px] text-neutral-400 font-light mt-1">Weddings, engagement parties, graduation celebrations.</p>
                  </div>
                  <div className="p-3 bg-neutral-50 border border-neutral-100 rounded-xl">
                    <span className="text-[9px] font-mono text-[#6C4CF1] font-bold">PHASE 4</span>
                    <h5 className="text-[11px] font-bold text-neutral-800 mt-1">Corporate</h5>
                    <p className="text-[9px] text-neutral-400 font-light mt-1">Employee birthdays, product launches, corporate team dinners.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-neutral-100 pt-6 mt-6">
                <p className="text-center text-xs font-display font-bold text-neutral-700 bg-neutral-50/80 border border-neutral-100 p-4 rounded-2xl max-w-xl mx-auto leading-relaxed">
